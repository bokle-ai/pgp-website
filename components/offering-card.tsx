...
const data = {
  plots: {
    ...
    imageAlt: "DTCP-approved plotted layout at dawn with palms and the Eastern Ghats",
  ...
  construction: {
    ...
    imageAlt: "Masons laying terracotta tiles on a mid-construction Tamil home at golden hour",
  ...
  resale: {
    ...
    imageAlt: "Two pairs of hands meeting over a hand-drawn DTCP layout plan with a gold-sealed document",
