    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-10 w-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 ml-auto">
          ...
          <span style={{ color: "var(--line-dark)" }} aria-hidden="true">·</span>

          <a
            href={`https://wa.me/${siteConfig.whatsapp}?text=Hi%2C%20I%27m%20interested%20in%20PGP%20plots.%20Can%20you%20share%20more%20details%3F`}
            target="_blank"
          ...
          <span style={{ color: "var(--line-dark)" }} aria-hidden="true" className="hidden sm:inline">·</span>
