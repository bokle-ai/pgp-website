    ...
    <>
      ...
      <main id="main-content" className="pt-40 pb-24">
        <div className="max-w-3xl mx-auto px-6 lg:px-10">
          <h1 className="mb-8" style={{ fontFamily: "var(--font-playfair, Georgia, serif)", fontWeight: 600, fontSize: "2.5rem", color: "var(--ink)" }}>Privacy Policy</h1>
          <div className="space-y-5 text-sm" style={{ color: "var(--ink-muted)", fontFamily: "var(--font-montserrat, sans-serif)", lineHeight: 1.75 }}>
